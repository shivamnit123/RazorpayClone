 ...
 * @since 2.6.1
 */
export var chainTaskEitherKW = function (f) { return flatMap(fromTaskEitherK(f)); };
/**
 * @category sequencing
 * @since 2.4.0
 */
...
export var chainReaderEitherKW = function (f) {
    return flatMap(fromReaderEitherK(f));
};
/**
 * @category sequencing
 * @since 2.11.0
 ...
 * @since 2.11.0
 */
export var chainReaderTaskKW = function (f) { return flatMap(fromReaderTaskK(f)); };
/**
 * @category sequencing
 * @since 2.11.0
 */
 ...
 * @since 2.13.0
 */
export var chainReaderIOKW = function (f) { return flatMap(fromReaderIOK(f)); };
/**
 * @category sequencing
 * @since 2.13.0
 */
