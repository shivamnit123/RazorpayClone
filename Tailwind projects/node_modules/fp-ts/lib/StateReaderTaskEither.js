...
var chainIOEitherKW = function (f) {
    return function (ma) {
        return (0, exports.flatMap)(ma, (0, exports.fromIOEitherK)(f));
    };
};
...
var chainTaskEitherKW = function (f) {
    return function (ma) {
        return (0, exports.flatMap)(ma, (0, exports.fromTaskEitherK)(f));
    };
};
